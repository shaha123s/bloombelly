...
/// Background & AppBar
/// The page sits on the familiar pastel purple‑blue watercolor background.
///
/// A slim AppBar at the top includes a back‑arrow on the left and the title
/// “Chat” centered.
/// Screen Title & Icon
/// Below the AppBar, large centered text reads “stage of pregnancy” in a
/// clean, dark sans‑serif font.
/// Directly underneath is a simple heart‑shaped line drawing of mother +
/// baby, sized so it feels balanced above the form.
/// Instructional Prompt
/// A single line of helper text—“At what stage of your pregnancy”—appears in
/// medium‑purple, giving context.
/// Three Input Cards
/// Each question sits in its own white, rounded‑corner card with internal
/// padding:
/// Enter your period date
/// Label in bold purple.
/// Beneath it, a text field placeholder (e.g. “MM/DD/YYYY”) set into a softly
/// rounded input box.
/// Enter your pregnancy date
/// Same style: bold purple label + rounded input box below.
/// Enter your due date
/// Again, matching label + input.
/// All three cards share identical styling—white fill, gentle shadow,
/// comfortable padding, and rounded corners.
/// Action Button
/// Under the inputs, a full‑width, pill‑shaped button in soft blue reads
/// “Check Nutrition” (you can relabel to “Calculate Stage” or similar once
/// you wire up the logic).
/// The button’s text is white and centered, with enough vertical padding for
/// easy tapping.
/// Layout & Spacing
/// Stack everything vertically, center‑aligned.
/// Add generous gaps (about 24px) between the icon, the prompt, each input
/// card, and the button so nothing feels crowded.
/// Wrap the column in a scroll view to ensure the form scrolls if the screen
/// is too small.
class DateWidget extends StatefulWidget {
  const DateWidget({super.key});

  static String routeName = 'date';
  static String routePath = '/date';
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        onChanged: (val) async {
                          ...
                          _model.selectedInputType = valueOrDefault<String>(
