                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                _model.apiResultc6l =
                                    await GetBabyAdviceCall.call(
                                  question: _model.textController.text,
                                );

                                if ((_model.apiResultc6l?.succeeded ?? true)) {
                                  _model.mymessage = valueOrDefault<String>(
                                    _model.textController.text,
                                    'response',
                                  );
                                  _model.botmesage = valueOrDefault<String>(
                                    getJsonField(
                                      (_model.apiResultc6l?.jsonBody ?? ''),
                                      r'''$.response''',
                                    )?.toString(),
                                    'response',
                                  );
