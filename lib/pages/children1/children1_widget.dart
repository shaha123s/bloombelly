...
class _Children1WidgetState extends State<Children1Widget> {
  late Children1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Children1Model());
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context
                                        .pushNamed(Children2Widget.routeName);
                                  },
                                  text: 'التالي',
