  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ChildrenRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChildrenRow> children1ChildrenRowList = snapshot.data!;

        final children1ChildrenRow = children1ChildrenRowList.isNotEmpty
            ? children1ChildrenRowList.first
            : null;
