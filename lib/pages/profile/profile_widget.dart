  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ChildrenRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChildrenRow> profileChildrenRowList = snapshot.data!;

        final profileChildrenRow = profileChildrenRowList.isNotEmpty
            ? profileChildrenRowList.first
            : null;
