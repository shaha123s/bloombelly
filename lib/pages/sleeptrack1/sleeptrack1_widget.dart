                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'vwg07qur' /* ملاحظات حول جدول النوم */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await SleepFeedTable().insert({
                            'record_date':
                                supaSerialize<DateTime>(getCurrentTimestamp),
                            'sleep_start': supaSerialize<PostgresTime>(
                                PostgresTime(_model.datePicked1)),
                            'sleep_end': supaSerialize<PostgresTime>(
                                PostgresTime(_model.datePicked2)),
                          });

                          context.pushNamed(Sleeptrack2Widget.routeName);
                        },
                        text: FFLocalizations.of(context).getText(
                          'si4cnuyw' /* حفظ */,
                        ),
