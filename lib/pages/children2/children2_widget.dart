...
class _Children2WidgetState extends State<Children2Widget> {
  late Children2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Children2Model());
