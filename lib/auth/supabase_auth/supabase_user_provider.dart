...
class Bloom2222SupabaseUser extends BaseAuthUser {
  Bloom2222SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> bloom2222SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Bloom2222SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
